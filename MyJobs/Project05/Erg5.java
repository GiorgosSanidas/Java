...
import javax.swing.*;
public class Erg5 extends JApplet 
{
private static final long serialVersionUID = -827175473341332608L;



String[] options = {"Please Select An Option from the Menu: ","Register Departure Airport","Register Destination Airport"};
private JTextField nameOfAirport = new JTextField(10);
...
public void init() 
{
    ...
    jpTextField.add(new JLabel("Airport Name: "),BorderLayout.WEST);
        jpTextField.add(nameOfAirport,BorderLayout.WEST);
        nameOfAirport.setHorizontalAlignment(JTextField.LEFT);
