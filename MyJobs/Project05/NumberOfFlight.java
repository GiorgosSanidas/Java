...
import javax.swing.*;
public class NumberOfFlight extends JApplet 
{
private static final long serialVersionUID = -827175473341332608L;



String[] options = {"Please add number of flight"};
private Component numberOfFlight;
...
public void init() 
{
    ...
    jpTextField.add(new JLabel("Number of flight: "),BorderLayout.WEST);
        jpTextField.add(numberOfFlight,BorderLayout.WEST);
        ((AbstractButton) numberOfFlight).setHorizontalAlignment(JTextField.LEFT);
...
{
    run(new NumberOfFlight(), 400, 400);
}
