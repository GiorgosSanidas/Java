...
import javax.swing.*;
public class Identity extends JApplet 
{
private static final long serialVersionUID = -827175473341332608L;



String[] options = {"Please add ID Number"};
...
public void init() 
{
    ...
    jpTextField.add(new JLabel("ID: "),BorderLayout.WEST);
        jpTextField.add(id,BorderLayout.WEST);
