...
import javax.swing.*;
public class NumberOfPassengers extends JApplet 
{
private static final long serialVersionUID = -827175473341332608L;



String[] options = {"Please add number of passengers"};
private Component numberOfPassengers;
...
public void init() 
{
    ...
    jpTextField.add(new JLabel("Number of passengers: "),BorderLayout.WEST);
    jpTextField.add(numberOfPassengers,BorderLayout.WEST);
    ((AbstractButton) numberOfPassengers).setHorizontalAlignment(JTextField.LEFT);
...
{
    run (new NumberOfPassengers(), 400, 400);
}
