...
import javax.swing.*;
public class SeatNumber extends JApplet 
{
private static final long serialVersionUID = -827175473341332608L;



String[] options = {"Please add seat number"};
private Component seat ;
...
public void init() 
{
    ...
    jpTextField.add(new JLabel("Seat: "),BorderLayout.WEST);
        jpTextField.add(seat,BorderLayout.WEST);
        ((AbstractButton) seat).setHorizontalAlignment(JTextField.LEFT);
